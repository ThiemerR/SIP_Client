...
public class RtpStreamReceiver extends Thread {
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			setMode(speakermode);
			enableBluetooth(PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_BLUETOOTH,
					com.sip_client.ui.Settings_Fragment.DEFAULT_BLUETOOTH));
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*com.sip_client.ui.Settings_Fragment.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				...
				if (oldring > 0) setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						com.sip_client.ui.Settings_Fragment.getEarGain()*3), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						(ogain = com.sip_client.ui.Settings_Fragment.getEarGain()*2)
						,AudioTrack.getMaxVolume()*
						com.sip_client.ui.Settings_Fragment.getEarGain()*2);
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_OLDVALID, com.sip_client.ui.Settings_Fragment.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(com.sip_client.ui.Settings_Fragment.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(com.sip_client.ui.Settings_Fragment.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(com.sip_client.ui.Settings_Fragment.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(com.sip_client.ui.Settings_Fragment.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(com.sip_client.ui.Settings_Fragment.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(com.sip_client.ui.Settings_Fragment.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(com.sip_client.ui.Settings_Fragment.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5) {
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_SETMODE, com.sip_client.ui.Settings_Fragment.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(com.sip_client.ui.Settings_Fragment.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_OLDVALID, com.sip_client.ui.Settings_Fragment.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.sip_client.ui.Settings_Fragment.PREF_OLDVIBRATE, com.sip_client.ui.Settings_Fragment.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.sip_client.ui.Settings_Fragment.PREF_OLDVIBRATE2, com.sip_client.ui.Settings_Fragment.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.sip_client.ui.Settings_Fragment.PREF_OLDPOLICY, com.sip_client.ui.Settings_Fragment.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(com.sip_client.ui.Settings_Fragment.PREF_OLDVALID, false);
			edit.commit();
	...
	void empty() {
		try {
			...
			if (!MainActivity.release) e2.printStackTrace();
		} catch (IOException e) {
		}
		try {
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_NODATA, com.sip_client.ui.Settings_Fragment.DEFAULT_NODATA);
		keepon = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_KEEPON, com.sip_client.ui.Settings_Fragment.DEFAULT_KEEPON);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*com.sip_client.ui.Settings_Fragment.getEarGain()));
		track.play();
		System.gc();
		empty();
		lockFirst = true;
	...
	private static void println(String str) {
		if (!MainActivity.release) System.out.println("RtpStreamReceiver: " + str);
	}
