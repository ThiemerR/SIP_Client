...
{  
   ...
   {  log=logger;
      ...
      try
      {
    	 ...
    	 if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_CALLRECORD,
    	         com.sip_client.ui.Settings_Fragment.DEFAULT_CALLRECORD))
  ...
  public boolean sendDTMF(char c){
   ...
   {
	  if (MainActivity.release) return;
