...
import org.sipdroid.sipua.base.*;
	...
	public class Receiver extends BroadcastReceiver {
			...
			if (call_state != state) {
				...
				case UserAgent.UA_STATE_INCOMING_CALL:
					...
					if ((pstn_state == null || pstn_state.equals("IDLE")) &&
							PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_AUTO_ON, com.sip_client.ui.Settings_Fragment.DEFAULT_AUTO_ON) &&
						...
						if (am.getStreamVolume(AudioManager.STREAM_RING) > 0) {				 
							String sUriSipRingtone = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_SIPRINGTONE,
		...
		public static void onText(int type,String text,int mInCallResId,long base) {
			...
			if (type >= REGISTER_NOTIFICATION && mInCallResId == R.drawable.sym_presence_available &&
					!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_REGISTRATION, com.sip_client.ui.Settings_Fragment.DEFAULT_REGISTRATION))
				text = null;
	        ...
	        if (text != null) {
				...
				if (type == MISSED_CALL_NOTIFICATION) {
			        	...
			        	if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_NOTIFY, com.sip_client.ui.Settings_Fragment.DEFAULT_NOTIFY)) {
					...
					if (base != 0) {
						...
						if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_POS, com.sip_client.ui.Settings_Fragment.DEFAULT_POS))
		...
		static void updateAutoAnswer() {
			if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_AUTO_ONDEMAND, com.sip_client.ui.Settings_Fragment.DEFAULT_AUTO_ONDEMAND) &&
				MainActivity.on(mContext)) {
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_AUTO_DEMAND, com.sip_client.ui.Settings_Fragment.DEFAULT_AUTO_DEMAND))
					updateAutoAnswer(1);
				else
					updateAutoAnswer(0);
			} else
		...
		public static void pos(boolean enable) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_POS, com.sip_client.ui.Settings_Fragment.DEFAULT_POS) ||
			PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_POSURL, com.sip_client.ui.Settings_Fragment.DEFAULT_POSURL).length() < 1) {
				if (lm != null && am != null) {
					pos_gps(false);
					pos_net(false);
					lm = null;
			...
			if (enable) {
				if (call_state == UserAgent.UA_STATE_IDLE && MainActivity.on(mContext) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_POS, com.sip_client.ui.Settings_Fragment.DEFAULT_POS) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_POSURL, com.sip_client.ui.Settings_Fragment.DEFAULT_POSURL).length()>0) {
		...
		static void enable_wifi(boolean enable) {
			if (!PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_OWNWIFI, com.sip_client.ui.Settings_Fragment.DEFAULT_OWNWIFI))
				return;
			if (enable && !PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_WIFI_DISABLED, com.sip_client.ui.Settings_Fragment.DEFAULT_WIFI_DISABLED))
        		return;
    		...
    		edit.putBoolean(com.sip_client.ui.Settings_Fragment.PREF_WIFI_DISABLED,!enable);
    		edit.commit();
    		/*
    		if (enable) {
		...
		public static void url(final String opt) {
	        (new Thread() {
				public void run() {
					try {
				        URL url = new URL(PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_POSURL, com.sip_client.ui.Settings_Fragment.DEFAULT_POSURL)+
				        		"?"+opt);
				        BufferedReader in;
						in = new BufferedReader(new InputStreamReader(url.openStream()));
				        in.close();
					} catch (IOException e) {
						if (!MainActivity.release) e.printStackTrace();
					}
		...
		public static void alarm(int renew_time,Class <?>cls) {
       		if (!MainActivity.release) Log.i("SipUA:","alarm "+renew_time);
		...
		static boolean on_vpn() {
			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_ON_VPN, com.sip_client.ui.Settings_Fragment.DEFAULT_ON_VPN);
		}
		
		static void on_vpn(boolean enable) {
    		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
    		
    		edit.putBoolean(com.sip_client.ui.Settings_Fragment.PREF_ON_VPN,enable);
    		edit.commit();
		}
		...
		public static boolean isFast(int i) {
        	...
        	if (PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_USERNAME+(i!=0?i:""),"").equals("") ||
        			PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_SERVER+(i!=0?i:""),"").equals(""))
        		return false;
        	if (wi != null) {
        		if (!MainActivity.release) Log.i("SipUA:","isFastWifi() "+WifiInfo.getDetailedStateOf(wi.getSupplicantState())
        				+" "+wi.getIpAddress());
	        	if (wi.getIpAddress() != 0 && (WifiInfo.getDetailedStateOf(wi.getSupplicantState()) == DetailedState.OBTAINING_IPADDR
	        		...
	        		on_wlan = true;
	        		if (!on_vpn())
	        			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_WLAN+(i!=0?i:""), com.sip_client.ui.Settings_Fragment.DEFAULT_WLAN);
	        		else
	        			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_VPN+(i!=0?i:""), com.sip_client.ui.Settings_Fragment.DEFAULT_VPN);  
	        	}
        	}
        	on_wlan = false;
			return isFastGSM(i);
		...
		static boolean isFastGSM(int i) {
        	...
        	if (tm.getNetworkType() >= TelephonyManager.NETWORK_TYPE_UMTS)
        		return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_3G+(i!=0?i:""), com.sip_client.ui.Settings_Fragment.DEFAULT_3G);
        	if (tm.getNetworkType() == TelephonyManager.NETWORK_TYPE_EDGE)
       			return PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_EDGE+(i!=0?i:""), com.sip_client.ui.Settings_Fragment.DEFAULT_EDGE);
        	return false;
		}
		...
		public void onReceive(Context context, Intent intent) {
        	...
        	if (!MainActivity.release) Log.i("SipUA:",intentAction);
		    ...
		    if (intentAction.equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_SELECTWIFI, com.sip_client.ui.Settings_Fragment.DEFAULT_SELECTWIFI))
	        ...
	        if (intentAction.equals(WifiManager.SCAN_RESULTS_AVAILABLE_ACTION)) {
	        	if (SystemClock.uptimeMillis() > lastscan + 45000 &&
	        			PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.sip_client.ui.Settings_Fragment.PREF_SELECTWIFI, com.sip_client.ui.Settings_Fragment.DEFAULT_SELECTWIFI)) {
		        	WifiManager wm = (WifiManager) mContext.getSystemService(Context.WIFI_SERVICE);
		        	WifiInfo wi = wm.getConnectionInfo();
		        	...
		        	if (configurations != null) {
		                ...
		                if (bestconfig != null &&
		               		...
		               		if (!MainActivity.release) Log.i("SipUA:","changing to "+bestconfig.SSID);
