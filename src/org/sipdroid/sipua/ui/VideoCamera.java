...
public class VideoCamera extends CallScreen implements 
    ...
    public void onStart() {
        ...
        videoQualityHigh = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_VQUALITY, com.sip_client.ui.Settings_Fragment.DEFAULT_VQUALITY).equals("high");
    ...
    public void onResume() {
        ...
        if (!justplay) {
			...
			try {
				...
				if (!MainActivity.release) e1.printStackTrace();
				super.onResume();
				finish();
				return;
			}
	        ...
	        startVideoRecording();
        } else if (Receiver.engine(mContext).getRemoteVideo() != 0 && PreferenceManager.getDefaultSharedPreferences(this).getString(com.sip_client.ui.Settings_Fragment.PREF_SERVER, com.sip_client.ui.Settings_Fragment.DEFAULT_SERVER).equals(com.sip_client.ui.Settings_Fragment.DEFAULT_SERVER)) {
