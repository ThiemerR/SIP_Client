...
public class AutoAnswer extends Activity {
	...
	boolean getMode() {
		return PreferenceManager.getDefaultSharedPreferences(this).getBoolean(Settings_Fragment.PREF_AUTO_DEMAND, Settings_Fragment.DEFAULT_AUTO_DEMAND);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		saveVolume();
		edit.putBoolean(Settings_Fragment.PREF_AUTO_DEMAND, !getMode());
		edit.commit();
		restoreVolume();
