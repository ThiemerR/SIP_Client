...
import org.sipdroid.sipua.base.UserAgentProfile;
						...
						if (lines.length == 2) {
							if (lines[0].equals("createButton"))
								...
								for (UserAgentProfile user_profile : Receiver.engine(Receiver.mContext).user_profiles) {
									if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getString(Settings_Fragment.PREF_DNS+i, Settings_Fragment.DEFAULT_DNS).equals(lines[0]) ||
