...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(com.sip_client.ui.Settings_Fragment.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : com.sip_client.ui.Settings_Fragment.DEFAULT_SIPRINGTONE);		
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.sip_client.ui.Settings_Fragment.PREF_SIPRINGTONE,
